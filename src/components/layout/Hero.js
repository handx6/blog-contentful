...
export default function Hero({ page }) {
  if (page === "Home") {
    return (
      <>
        <div className="h-screen bg-cover bg-center bg-hero flex flex-col justify-center text-white p-4 sm:px-20 md:px-32 sm:py-6">
    ...
    return (
      <>
        <div className="h-[calc(100vh_-_68px)] md:h-screen bg-cover bg-center bg-hero flex flex-col justify-end">
